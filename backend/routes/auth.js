...
// 🚀 X (TWITTER) OAUTH 2.0 REPAIR
// Point to the manual controller handler instead of direct passport
router.get('/twitter', authController.socialLogin('x'));
router.get('/x/callback', authController.socialCallback('x'));
